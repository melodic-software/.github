...
Decisions are made by the maintainers. Significant or hard-to-reverse decisions are recorded in the affected repository (for example, as Architecture Decision Records) so the rationale is durable.
